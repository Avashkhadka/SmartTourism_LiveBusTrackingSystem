...
<body>
    <section class="reg-log h-full reveal">
        <div class="flex w-full h-full " style=" flex-grow: 1;">
            <div class="py-8 px-16 w-144 mx-auto reveal ">
                ...
                <div class="text-center text-sm flex gap-2">

                    <a href="<?php echo BASEURL ?>/pages/sign-in.php" class=" py-2 px-4 border-gray rounded-full  text-black no-underline font-medium ">
                        Sign
                        in</a>
                    <a href="<?php echo BASEURL ?>/pages/driver-login.php"
                        class=" no-underline font-medium text-white py-2 px-4 bg-secondary rounded-full "> Submit for verification </a>
